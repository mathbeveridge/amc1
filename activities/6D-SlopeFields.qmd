...
2.  The initial amount of pollutant is 2000 gallons. Use the `plot_traj` command to create a trajectory for $0 \leq t \leq 50$. Set `numtick=10` to show 10 tick marks on your trajectory.
