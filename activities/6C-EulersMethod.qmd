...
Use Euler's Method to approximate the value $x(4)$ where $x(t)$ satisfies the differential equation \[ \frac{dx}{dt}=2x -6, \quad \mbox{where} \quad   x(0)=4 \] by using times $t_0=0$, $t_1=0.5$, $t_2=1.0$ and $t_3 = 1.5$. Here is a table to get you started. $$
