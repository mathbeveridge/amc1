...
A cupcake store finds that at a price of \$4.00, the demand is 400 cupcakes. For every $1 decrease in price, the demand increases by 80 cupcakes. 

1. Find the formula $r(x)$ for the revenue where $x$ is the decrease in price (in dollars).
