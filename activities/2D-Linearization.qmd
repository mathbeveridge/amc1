...
2.  The sugar solution needs to reach $289^\circ$F to be the consistancy of taffy. Estimate when this will happen.
...
1.  Let's use $f(t)$ to denote the temperature.We need to estimate the rate of change at $t=10$. We have $$ f'(10) \approx \frac{165 - 115}{10-5} = \frac{50}{5}=10$$. We use the linear approximation $$L_{10}(t) = 165 + 10 (t-10)$$ to estimate the temperature. We have $$f(17) \approx L_{10}(17) = 165 + 10 (17-10) = 235.$$

2.  We must solve $$ 289 = 165 + 10 (t-10) = 65t$$ to find that $10t = 224$ and so $t=22.4$ minutes.
